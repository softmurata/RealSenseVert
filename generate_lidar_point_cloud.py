...
def project_disp_to_depth(calib, rgb, depth, max_high):
...
if __name__ == '__main__':
    ...
    lidar_pcd, lidar_pcd_colors = project_disp_to_depth(calib, rgb, depth_map, args.max_high)
    ...
    # save raw point
    np.save(raw_point_save + 'test.npy', lidar_pcd)
    ...
    # save point cloud
    o3d.io.write_point_cloud(point_cloud_save + 'test.ply', pcd)
